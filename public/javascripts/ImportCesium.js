...
let syncViewer = function() {
    ...
    viewer_eye.camera.flyTo({
        destination: new Cesium.Cartesian3(viewer.camera.position.x, viewer.camera.position.y+(1000000/zoom), viewer.camera.position.z+(1000000/Math.pow(2,zoom))),
        orientation: {
